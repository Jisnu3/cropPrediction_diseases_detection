"""
Django settings for crop_recommend project.
...
ROOT_URLCONF = 'crop_recommend.urls'
...
WSGI_APPLICATION = 'crop_recommend.wsgi.application'
...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER") or "no-reply@cropai.local"
DEFAULT_FROM_EMAIL = os.getenv("EMAIL_HOST_USER") or "no-reply@cropai.local"
